...
#
# Script that uses an Convolutional Neural Network to predict dB_H/dt using solar wind and magnetometer data.
# This version will take the input features that have large positive and negative values and creating seperate
# var_pos and var_neg columns to try and imporve the value of the scaling. Will also take abs(Vx) to avoid
# the largest Vx value being 0, which could be an issue for the weights and the RelU activation function.
# 
